                    ...
                    <div className="auth-form-section">
                        ...
                        <form method="POST" className="auth-form">
                            <div className="form-group">
                                ...
                                <input type="email" name="username" id="username" className="form-control" value={email}
                                    onChange={(e:any) => setEmail(e.target.value)}
                                placeholder="Enter your email" required/>
                            </div>
                            <div className="form-group">
                                <label htmlFor="userPassword" className="sr-only">Password</label>
                                <input type="password" name="userPassword" id="userPassword" className="form-control" 
                                        value={password}
                                        onChange={(e:any) =>setPassword(e.target.value)}
                                placeholder="Password" required/>
                            </div>
                            <button type="submit" onClick={loginPage} className="btn btn-customize btn-success btn-block mb-3">Sign in</button>
